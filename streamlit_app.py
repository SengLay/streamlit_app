...
st.markdown("<div style='font-size: 25px';><b>Job Analysis Report</b></div>", unsafe_allow_html=True)
...
st.markdown("<div style='font-size: 25px';><b>Job Analysis Guideline</b></div>", unsafe_allow_html=True)
